...
{
    protected $name = "TaskDemo";
    protected static $defaultName = 'task:demo';
    /**
     * 所有操作
     * @var array
     */
    ...
    public function __construct(){
        parent::__construct();
        $this->pidFilePath =  __DIR__ . "/../bin/pids/demo.pid";
    }
    /**
     * 配置
     */
    ...
    {
        $this->setDescription('Demo TEst.')
            ->setAliases(['Task:Server', 'task_server'])
